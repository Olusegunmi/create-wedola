...
import DetailsImage from '../../assets/images/resource/news-details.jpg';
...
import NewsImage4 from '../../assets/images/resource/team3-5.jpg';
import NewsImage5 from '../../assets/images/resource/team3-3.jpg';
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="blog-details__left">
                        <div className="blog-details__img"><img src={DetailsImage} alt="Image" />
                        ...
                        <div className="comment-one__single">
                            <div className="comment-one__image"><img src={NewsImage4} alt="Image" /></div>
                            ...
                            <Link to="/news-details" className="theme-btn btn-style-one comment-one__btn"><span className="btn-title">Reply</span></Link></div>
                        </div>
                        <div className="comment-one__single">
                            <div className="comment-one__image"><img src={NewsImage5} alt="Image" /></div>
                            <div className="comment-one__content">
                            <h4>Sarah Albert</h4>
                            <p>Mauris non dignissim purus, ac commodo diam. Donec sit amet lacinia nulla.
                                Aliquam quis purus in justo pulvinar tempor. Aliquam tellus nulla,
                    ...
                    <div className="sidebar">
                        ...
                        <div className="sidebar__single sidebar__post">
                            ...
                            <ul className="sidebar__post-list list-unstyled">
                                <li>
                                    <div className="sidebar__post-image"><img src={NewsImage1} alt="Image" /></div>
                                    <div className="sidebar__post-content">
                                        <h3><span className="sidebar__post-content-meta"><i className="fas fa-user-circle" />Admin</span>
                                        <Link to="/news-details">Top crypto exchange influencers</Link> </h3>
                                    </div>
                                </li>
                                <li>
                                    <div className="sidebar__post-image"><img src={NewsImage2} alt="Image" /></div>
                                    <div className="sidebar__post-content">
                                        <h3><span className="sidebar__post-content-meta"><i className="fas fa-user-circle" />Admin</span>
                                        <Link to="/news-details">Necessity may give us best virtual court</Link> </h3>
                                    </div>
                                </li>
                                <li>
                                    <div className="sidebar__post-image"><img src={NewsImage3} alt="Image" /></div>
                                    <div className="sidebar__post-content">
                                        <h3> <span className="sidebar__post-content-meta"><i className="fas fa-user-circle" />Admin</span>
                                        <Link to="/news-details">You should know about business plan</Link> </h3>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="sidebar__single sidebar__tags">
                            ...
                            <div className="sidebar__tags-list">
                                ...
                                <Link to="/">Experience</Link> <Link to="/">Technology</Link> </div>
                            </div>
