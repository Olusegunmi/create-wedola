...
import EventImage from '../../assets/images/resource/event-details.jpg';
                        ...
                        <div className="col-xl-12">
                            <div className="project-details__top">
                                <div className="project-details__img">
                                    <img src={EventImage} alt="Event Details" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            <div className="col-xl-12">
                                <div className="project-details__content-left">
                                    <h3 className="mb-4 mt-5">Here to Know About This Event</h3>
                                    ...
                                    <ul className="list-style-two mb-0">
                                        <li><i className="fa fa-check-circle" /> Lorem ipsum dolor amet consectetur</li>
                                        <li><i className="fa fa-check-circle" /> Vitae pariatur molestiae odit quos enim</li>
                                        <li><i className="fa fa-check-circle" /> Beyond more stoic this along goodness</li>
